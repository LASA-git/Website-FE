...
export default function RecentEventsGallery({
  title = 'Community Highlights',
  description = 'A look at our recent community service activities and stories.',
  className = '',
  showHeader = true,
  showCarousel = true,
}) {
      ...
      <div className="mx-auto w-full max-w-6xl">
        {showHeader && (
          <div className="mb-8 text-center">
            <h2 className="text-2xl font-display text-lasa-700 sm:text-3xl md:text-4xl">{title}</h2>
        ...
        {!loading && !error && (
          <div className="space-y-10">
            {showCarousel && (
              <div>
                {carouselItems.length ? (
                  <div className="group relative mx-auto mt-4 max-w-4xl overflow-hidden rounded-2xl border border-lasa-200 bg-white shadow-lg">
                    <div
